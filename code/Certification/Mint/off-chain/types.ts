...
// On Cardano, all addresses related hashes are 28 bytes (blake2b_224).
// The type of a hash with the constraint that it must be of the exact size of 28 bytes
export const AddressHash = L.Data.Object({
    hash: L.Data.Bytes({ minLength: 28, maxLength: 28 }),
});
export type AddressHash = L.Data.Static<typeof AddressHash>;
...
export const PubKeyHash = L.Data.Object({
    pubKeyHash: AddressHash
})
export type PubKeyHash = L.Data.Static<typeof PubKeyHash>

export const ValidatorHash = L.Data.Object({
    pubKeyHash: AddressHash
})
